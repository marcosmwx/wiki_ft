...
:::tip[O que é crontab❓]
 É um gestor de processos em segundo plano. Os processos especificados serão executados no momento que especificar no arquivo crontab
 :::

 Para termos a crontab correctamente configurada, devemos editar o arquivo crontab com o seguinte comando: `sudo crontab -u root -e`.
...
h -➤ A hora exata, o formato de 24 horas é utilizado, os valores variam entre 0 e 23, sendo 0 às 12:00 da meia-noite.
